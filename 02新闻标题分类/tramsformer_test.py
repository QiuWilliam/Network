...
def evaluate(model,  dev_loader, loss_fn,  device, n_epochs):
    best_accuracy = 0
...
# 加载预训练的权重
model_path = 'tranformer_best_model_state.bin'  # 更新为正确的文件名
...
evaluate(model, dev_loader, loss_fn, device, n_epochs=3)
